...
//     .filter(subject => subject.subjectName.toLowerCase().includes(filter.toLowerCase()) || subject.unitName.toLowerCase().includes(filter.toLowerCase()))
//     // for reducing duplicates Subjects Name.
//     .reduce((acc, current) => {
...
//                   Subject Name: <span className='text-red-400 flex items-center justify-center'>{subject.subjectName}</span>
//                 </h2>
